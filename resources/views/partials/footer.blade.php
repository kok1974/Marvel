<footer class="row mx-0 px-0 contacto">

    <div class="col-6 col-md-3">
        <H2>Mis colecciones Marvel</H2>
        <P>C/falsa nº 123456</P>
        <P>Ciudad desconocida</P>
    </div>
    <div class="col-6 col-md-3 " id="contacto">
        <a class="desktopNav__logo" href="/">
